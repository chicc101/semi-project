...
<body>
    ...
    <div class="main-body"> <!--전체div-->
        <form method="post" action="#"> <!--form태그 시작-->
            <h1 class="main-title">L O G I N</h1> <!--title-->
            ...
            <p class="title">
                <a href="findId2.html">아이디 찾기 |</a> <!--findId2페이지로 이동-->
                <a href="findPassword.html">비밀번호 재설정</a> <!--findPassword페이지로 이동-->
            </p>

            <p>
                <input class="login-button" type="submit" value="로그인"
                onclick="location.href='#'"> <!--로그인성공페이지로이동-->
            </p> 
        </form> <!--form태그 끝-->
        ...
        <p>
            ...
            onclick="location.href='#'"> <!--회원가입페이지로이동-->
        </p>
